...
void MainWindow::keyPressEvent(QKeyEvent *e)
{
    switch(e->key())
    {
        ...
        case Qt::Key_W : rasterizer.cam.translateZ(0.5); break;

        case Qt::Key_S : rasterizer.cam.translateZ(-0.5); break;

        case Qt::Key_A : rasterizer.cam.translateX(-0.5); break;

        case Qt::Key_D : rasterizer.cam.translateX(0.5); break;

        case Qt::Key_Q : rasterizer.cam.translateY(-0.5); break;

        case Qt::Key_E : rasterizer.cam.translateY(0.5); break;

        case Qt::Key_Right : rasterizer.cam.rotateY(-5); break;

        case Qt::Key_Left : rasterizer.cam.rotateY(5); break;

        case Qt::Key_Down : rasterizer.cam.rotateX(5); break;

        case Qt::Key_Up : rasterizer.cam.rotateX(-5); break;

        case Qt::Key_Z : rasterizer.cam.rotateZ(5); break;

        case Qt::Key_X : rasterizer.cam.rotateZ(-5); break;
